...
export default function VisualEvent({ isActive }: { isActive: boolean }) {
  ...
  return (
    ...
    >
      ...
      <img src="/departments/EM.png" alt="Event Management" className="absolute w-24 h-24 object-contain drop-shadow-[0_0_25px_rgba(103,232,249,0.5)] z-10 animate-pulse" />
    </motion.div>
  );
}
